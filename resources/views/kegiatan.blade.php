...
<head>
        <title>Teknik Informatika - Kegiatan</title>
        <meta charset="utf-8">
                            ...
                            <li class="grid-item">
                                <div class="card border-0 border-radius-5px box-shadow-quadruple-large box-shadow-quadruple-large-hover">
                                    <div class="blog-image">
                                        <a href="/detail-kegiatan" class="d-block"><img src="images/example1.jpeg" alt="" /></a>
                                        <div class="blog-categories">
                                            <a href="/detail-kegiatan" class="categories-btn bg-white text-dark-gray text-dark-gray-hover text-uppercase fw-700">Kegiatan 1</a>
                                        </div>
                                    </div>
                                    <div class="card-body p-12 lg-p-10">
                                        <a href="/detail-kegiatan" class="card-title mb-15px fw-600 fs-20 text-dark-gray d-inline-block">Exploring the evolution of electric charging technology.</a>
                                        ...
                                        <div class="author d-flex justify-content-center align-items-center position-relative overflow-hidden fs-14 text-uppercase">
                                            <div class="me-auto">
                                                ...
                                                <div class="d-inline-block author-name fw-600 text-dark-gray"><a href="/detail-kegiatan" class="text-dark-gray text-decoration-line-bottom">Tri Ramdhan Septiadi</a></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="blog-image">
                                        ...
                                        <div class="blog-categories">
                                            <a href="/detail-kegiatan"
                                               class="categories-btn bg-white text-dark-gray text-dark-gray-hover text-uppercase fw-700">Kegiatan 2</a>
                                        </div>
                                    </div>
                                    <div class="card-body p-12 lg-p-10">
                                        <a href="/detail-kegiatan" class="card-title mb-15px fw-600 fs-20 text-dark-gray d-inline-block">Renewable energy sources for a brighter tomorrow.</a>
                                        <p>Lorem ipsum dolor consectetur adipiscing eiusmod tempor...</p>
                                        <div class="author d-flex justify-content-center align-items-center position-relative overflow-hidden fs-14 text-uppercase">
                                            <div class="me-auto">
                                                <span class="blog-date d-inline-block fw-600 text-dark-gray">13 Februari 2025</span>
                                                <div class="d-inline-block author-name fw-600 text-dark-gray"><a href="/detail-kegiatan" class="text-dark-gray text-decoration-line-bottom">Arif Rachmat Darmawan</a></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <li class="grid-item">
                                <div
                                    ...
                                    <div class="blog-image">
                                        <a href="/detail-kegiatan" class="d-block"><img src="images/example1.jpeg" alt="" /></a>
                                        <div class="blog-categories">
                                            <a href="/detail-kegiatan" class="categories-btn bg-white text-dark-gray text-dark-gray-hover text-uppercase fw-700">Kegiatan 3</a>
                                        </div>
                                    </div>
                                    <div class="card-body p-12 lg-p-10">
                                        <a href="/detail-kegiatan" class="card-title mb-15px fw-600 fs-20 text-dark-gray d-inline-block">Exploring green energy solutions for a cleaner future.</a>
                                        <p>Lorem ipsum dolor consectetur adipiscing eiusmod tempor...</p>
                                        <div class="author d-flex justify-content-center align-items-center position-relative overflow-hidden fs-14 text-uppercase">
                                            <div class="me-auto">
